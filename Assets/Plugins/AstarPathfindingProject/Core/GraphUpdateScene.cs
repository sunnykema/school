...
namespace Pathfinding {
	...
	public class GraphUpdateScene : GraphModifier {
		...
		public void OnDrawGizmos (bool selected) {
			...
			Color c = selected ? new Color (0/255f,0/255f,255/255f,1.0f) : new Color (0/255f,0/255f,255/255f,0.9f);
			...
			if (convex) {
				...
				Gizmos.color = selected ? new Color (0/255f,0/255f,255/255f,1.0f) : new Color (0/255f,0/255f,255/255f,0.9f);
