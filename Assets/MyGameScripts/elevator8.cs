...
public class elevator8 : MonoBehaviour
{
    ...
    Vector3 po5;
    Vector3 po6;
    protected float temp1 = 275.23f;         //电梯门的开门距离
    protected float temp2 = 270.54f;
    protected float temp3 = 273.64f;
    protected float temp4 = 271.81f;
    ...
    public void Awake()
    {
        ...
        Plane = GameObject.Find("eleplane8");
    }
    ...
    void Update()
    {
        ...
        if (Select_B || Select_C)           //选定楼层之后，关门并计时，到达一定时间就上升
        {
            Is_Click_Button = false;
            // print("Is_Click_Button = " + Is_Click_Button);
            Close_Door();
