...
public class elevator3 : MonoBehaviour
{
    ...
    Vector3 po5;
    Vector3 po6;
    protected float temp1 = 226.44f;         //电梯门的开门距离
    protected float temp2 = 221.84f;
    protected float temp3 = 225.01f;
    protected float temp4 = 223.19f;
    ...
    public void Awake()
    {
        ...
        Plane = GameObject.Find("eleplane3");
    }
