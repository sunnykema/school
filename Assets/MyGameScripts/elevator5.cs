...
public class elevator5 : MonoBehaviour
{
    ...
    Vector3 po5;
    Vector3 po6;
    protected float temp1 = 275.51f;         //电梯门的开门距离
    protected float temp2 = 270.61f;
    protected float temp3 = 273.96f;
    protected float temp4 = 272.18f;
    ...
    public void Awake()
    {
        ...
        Plane = GameObject.Find("eleplane5");
    }
