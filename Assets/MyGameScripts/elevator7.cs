...
public class elevator7: MonoBehaviour
{
    ...
    Vector3 po5;
    Vector3 po6;
    protected float temp1 = 212.0f;         //电梯门的开门距离
    protected float temp2 = 207.37f;
    protected float temp3 = 210.25f;
    protected float temp4 = 208.44f;
    ...
    public void Awake()
    {
        ...
        Plane = GameObject.Find("eleplane7");
    }
