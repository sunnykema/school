...
public class elavator : MonoBehaviour
{
    ...
    Vector3 po5;
    Vector3 po6;
    protected float temp1 = 260.0f;         //电梯门的开门距离
    protected float temp2 = 254.8f;
    protected float temp3 = 258.3f;
    protected float temp4 = 256.5f;
    ...
    public void Awake()
    {
        ...
        Plane = GameObject.Find("eleplane1");
    }
    ...
    public void Judge_Onplane()                 //用于计算电梯板和游戏体的距离差
    {
        ...
        if (x < On_Floor_Distance && z < On_Floor_Distance && y < 2.0f)
        {
            Is_Onplane = true;
            myLift.active = true;
        }          //如果电梯与游戏体在同一层楼，则可以开门 
