...
public class elevator2 : MonoBehaviour
{
    ...
    Vector3 po5;
    Vector3 po6;
    protected float temp1 = 260.75f;         //电梯门的开门距离
    protected float temp2 = 256.0f;
    protected float temp3 = 259.23f;
    protected float temp4 = 257.44f;
    ...
    public void Awake()
    {
        ...
        Plane = GameObject.Find("eleplane2");
    }
