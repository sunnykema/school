...
public class elevator4 : MonoBehaviour
{
    ...
    Vector3 po5;
    Vector3 po6;
    protected float temp1 = 225.51f;         //电梯门的开门距离
    protected float temp2 = 220.85f;
    protected float temp3 = 224.16f;
    protected float temp4 = 222.32f;
    ...
    public void Awake()
    {
        ...
        Plane = GameObject.Find("eleplane4");
    }
